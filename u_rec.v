...
module u_rec #(parameter WIDTH=8) (
    ...
    always @ (posedge uart_clk or negedge sys_rst_l) begin  
        if (!sys_rst_l) begin
            ...
            if ((c_state==START)||(c_state==STOP))  baud_count<=baud_count+1'b1;
    ...
    always @(*)begin
        ...
        case(c_state)
            IDLE: begin
                rec_readyH=1'b1;
                if (!uart_REC_dataH)    n_state=START;
                else                    n_state = IDLE;
                bit_index=4'd0;
            end
            ...
            START: begin
                ...
                else if(bit_index==WIDTH+1) begin
            ...
            DATA: begin
                if((bit_index==4'd0)&&(sync_ff[1]!=1'b0)) begin
                    ...
                    rec_busyH=1'b1;
                    rec_readyH=1'b0;
                    shift_reg={sync_ff[1],shift_reg[WIDTH-1:1]};
